    ...
    function pairName(
        ...
        return
            string(
                abi.encodePacked(
                    prefix,
                    SafePEP20Namer.tokenName(token0),
                    TOKEN_SEPARATOR,
                    SafePEP20Namer.tokenName(token1),
                    suffix
                )
            );
    }
    ...
    function pairSymbol(
        ...
        return
            string(
                abi.encodePacked(
                    TOKEN_SYMBOL_PREFIX,
                    SafePEP20Namer.tokenSymbol(token0),
                    TOKEN_SEPARATOR,
                    SafePEP20Namer.tokenSymbol(token1),
                    suffix
                )
            );
    }
