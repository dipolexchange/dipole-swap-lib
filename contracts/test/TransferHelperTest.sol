...
contract TransferHelperTest {
    ...
    function safeTransferLAT(address to, uint256 value) external {
        TransferHelper.safeTransferLAT(to, value);
    }
}

// can revert on failure and returns true if successful
contract TransferHelperTestFakePEP20Compliant {
    bool public success;
...
contract TransferHelperTestFakePEP20Noncompliant {
    bool public shouldRevert;
